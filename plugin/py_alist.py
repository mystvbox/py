...
class Spider(Spider):  # 元类 默认的元类 type
    ...
    def categoryContent(self, tid, pg, filter, extend):
        ...
        for vod in vodList:
            ...
            #计算文件大小
                ...
                remark = str(sz) + fs
                # 开始爬视频与字幕
                if 'mp4' in vod['name'] or 'mkv' in vod['name'] or 'TS' in vod['name'] or 'flv' in vod['name'] or 'rmvb' in vod['name'] or 'mp3' in vod['name'] or 'flac' in vod['name'] or 'wav' in vod['name'] or 'wma' in vod['name'] or 'wma' in vod['name'] or 'dff' in vod['name']:
                    cid = ''
                    for temvod in vodList:
                        if 'mp4' in temvod['name'] or 'mkv' in temvod['name'] or 'TS' in temvod['name'] or 'flv' in temvod['name'] or 'rmvb' in temvod['name'] or 'mp3' in temvod['name'] or 'flac' in temvod['name'] or 'wav' in temvod['name'] or 'wma' in temvod['name'] or 'wma' in temvod['name']  or 'dff' in temvod['name']:
    ...
    def detailContent(self, array):
        ...
        if self.ver == '' or self.baseurl == '':
            self.getVersion(url)
        baseurl = self.baseurl
        dir = re.findall(r"(.*)/", url.replace(baseurl, ""))[0].replace(baseurl, "")
        vod = {
            "vod_id": dir,
            "vod_name": dir,
            "vod_pic": '',
